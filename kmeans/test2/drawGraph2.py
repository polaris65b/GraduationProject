...
# 모델 불러오기
model1 = joblib.load('C:\\dev\\koreatech\\graduationProject\\MRT_koreatech\\kmeans\\test2\\trained_model_with_balance.pkl')
model2 = joblib.load('C:\\dev\\koreatech\\graduationProject\\MRT_koreatech\\kmeans\\test2\\trained_model_with_balance2.pkl')
